<template>
    <div>
        ...
        <el-dialog
            ...
            width="50%" @close="addFromRefClose">   
            <!-- 内容主体区域        -->
    ...
    methods:{
        async getUserList(){
            ...
            if(res.meta.status !==200){
                return this.$message.error('获取列表用户失败');               
            }
        ...
        async userStateChanged(userInfo){
            ...
            if(res.meta.status !==200){
                ...
                return this.$message.error('更新用户失败啦！')
            }
        ...
        editUserInfo(){
            this.$refs.editFormRef.validate(async valid =>{
                ...
                if(res.meta.status !=200){
                    return this.$message.error('更新列表失败啦')
                }
                // 关闭对话框
